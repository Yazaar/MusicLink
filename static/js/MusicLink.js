(function(){
    ...
    var HTMLAgentConfigs = {
        ...
        soundcloud: {"elements":[{"name":"title","path":".playbackSoundBadge__title a span:nth-child(2)","type":"text"},{"name":"author","path":".playbackSoundBadge__titleContextContainer a","type":"text"},{"name":"totalTime","path":".playbackTimeline__progressBackground","argument":"width","type":"cssprocessed"},{"name":"currentTime","path":".playbackTimeline__progressBar","argument":"width","type":"cssprocessed"},{"name":"CSSURLthumbnail","path":".playbackSoundBadge div.image span","argument":"background-image","type":"cssstyle"}],"name":"SoundCloud","responseFormat":"","responseFormatDummy":"","website":"soundcloud.com"}
    };
